...
var almacen2;
var almacen3;
var alma2 = new Eureca.Client({ uri: 'http://localhost:8070' });
var alma3 = new Eureca.Client({ uri: 'http://localhost:8060' });

alma2.ready(function (serverProxy) {

     almacen2=serverProxy;
            ...
            // Si no tengo lo requerido hago esto
              ...
              //    comidaAlma.quitarKilos(requ);
                 ...
                 hor.setInventario(inventario,miNumero);//Actualizo mi inventario.
                  ...
                  if(almacen[1]){ // Si en el itinierario esta el almacen 2
                      almacen2.recibirHormiga(hor);
                  }else{
...
console.log("Inventario despues de la hormiga. "+ inventario);
